...
public int timesToRunSuiteInMain = 1;
...
private ResultPair invalidPaths[] = { new ResultPair("/..", false),  new ResultPair("/../", false), new ResultPair("/#", false), new ResultPair("/../file", false), new ResultPair("/..//file", false), new ResultPair("/#/file", false), new ResultPair("//key", false),  new ResultPair(":/files", false) }; 
...
public void manualValidTests() {
   ...
   assertTrue(urlVal.isValid("ldap://www.google.com/c=GB?objectClass?one"));
